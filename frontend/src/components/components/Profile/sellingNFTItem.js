                                ...
                                <div className="nft__item position-relative h-100 justify-content-between">
                                    ...
                                    <div className="nft__item_info">
                                        ...
                                        <div className="pb-4 trade-btn-group mt-2">
                                            ...
                                            { nft.status === 'normal' ? <span className="btn-main mt-2 w-100" onClick={async() => await updatePremiumNFT(nft.tokenID, "premium")}>Promote to preimum</span> : <span className="btn-main mt-2 w-100"  onClick={() => updatePremiumNFT(nft.tokenID, "normal")}>Reset to normal</span> }
                                        </div>
                                    </div> 
                                </div>
                            </div>
